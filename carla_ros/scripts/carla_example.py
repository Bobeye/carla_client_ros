...
def use_example(ini_file,port = 2000, host ='127.0.0.1',print_measurements =True,images_to_disk=False):
...
if __name__ == "__main__" :
	...
	use_example(args.config,port=args.port, host=args.host,print_measurements=True,images_to_disk= args.images_to_disk)
